...
_SRC=sprites.c display.c window.c debug.c instr_win.c reg_win.c instructions.c registers.c keys.c main.c
SRC=$(patsubst %,$(SDIR)/%,$(_SRC))

_OBJ=sprites.o display.o window.o debug.o instr_win.o reg_win.o instructions.o registers.o keys.o main.o
